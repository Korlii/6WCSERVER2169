...
// This responds a GET request for korli
app.get("/korli", function(request, response){
    console.log("Got a GET request for /korli")
    response.send("Welcome to Korli's page! <3 <br><br>**Profile**<br><br>Name: Adrian D. Curley<br>Age: 20<br>Course: Information Technology - Web Development");
});
